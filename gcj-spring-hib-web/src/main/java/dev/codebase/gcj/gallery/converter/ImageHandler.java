 ...
 * Imaging and Java 2D APIs are frustratingly in flux, this is a pretty basic go-between 
 * that performs ulta-simple imaging processes on given images, like a PhotoShop Super LE API
 */
